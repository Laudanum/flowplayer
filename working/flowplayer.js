/*!
   ...
   Flowplayer v5.3.2 (2013-02-20) | flowplayer.org/license
...
$.fn.flowplayer = function(opts, callback) {
   ...
   return !opts && this.data("flowplayer") || this.each(function() {
      ...
      var root = $(this).addClass("is-loading"),
         ...
         videoTag = $(tagname, root).addClass("fp-engine").removeAttr("controls"),
...
//            @TODO support audio
         if (support.audio) {
            for (var i = 0, source; i < sources.length; i++) {
               // if we can we need to alter the videoTag
               if (canPlay(sources[i].type)) {
                  videoTag = $("audio", root);
                  return sources[i];
               }
            }
